...
ubuntu_install(){
  ...
  sudo apt-get install -y apt-transport-https nfs-common ca-certificates curl software-properties-common jq
  ...
  sudo apt-get install -y python python-pip socat unzip moreutils glusterfs-client nfs-common
...
crlinux_install(){
  ...
  sudo yum -y install python-setuptools policycoreutils-python socat unzip glusterfs-client nfs-utils jq
